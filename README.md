...
One more honest measurement. I scanned the reader's own niche manhwa sites — the ongoing Korean/Chinese scanlation stuff AniList is supposed to undercover — expecting a big haul. **25 of 33 candidates were already in the corpus**, often hiding under alternate translations (*Volcanic Age* = *Hwasanjeonsaeng*, *Mercenary Enrollment* = *Teenage Mercenary*). Eight were genuinely new and got added. The repeated result across every source — mainstream and niche — is the same: a popularity-ranked corpus of a couple thousand titles already covers a dark-taste reader almost completely. The work was never finding more. It was making the map honest, and getting out of the way.
